            ...
            <body className={`${comfortaa.variable} antialiased font-sans`}>
                <ThemeProvider>
                    <LanguageProvider>
                        ...
                        <main className="min-h-screen bg-slate-200 dark:bg-slate-900 text-slate-800 dark:text-slate-200 text-sm sm:text-base flex items-start justify-center py-24 lg:py-30">
                            {children}
                        </main>
                        <footer>
                            <Footer />
