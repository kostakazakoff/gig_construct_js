...
export default function NewsCard({ newsItem }) {
    ...
    return (
        <div className="max-w-6xl flex flex-col gap-16">
            <section className="relative sticky z-20 top-20 flex justify-between items-start gap-24">
                ...
                <div className="absolute -z-2 w-full h-1 bg-slate-100 dark:bg-slate-700 shadow-md/20 w-full" />
            </section>
            <section className="bg-slate-100 dark:bg-slate-700 p-8 sm:p-12 flex flex-col sm:flex-row">
                <div className="relative mb-2 overflow-hidden h-48 w-64 rounded-sm shrink-0 shadow-md border-2 float-left mr-4 border-slate-400">
                    <Image
