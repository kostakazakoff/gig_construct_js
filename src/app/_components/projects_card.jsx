...
export default function ProjectsCard({ project, staticData }) {
    return (
        <div className="group max-w-xl hover:shadow-xl hover:scale-105 transition duration-300 ease-in-out border-l-6 border-b-1 border-r-1 hover:border-gig-blue dark:hover:border-blue-400 rounded-lg">
                ...
                <div className="min-w-0 w-80 md:w-140 xl:w-160 2xl:w-200 h-auto flex flex-col justify-between">
                    <div className="min-w-0 mb-auto">
                        ...
                        <div className="mt-4">
                            ...
                            <p className="mt-1 text-sm text-justify indent-8 md:text-base">{project.description}</p>
                        </div>
                    </div>
                </div>
            </Link>
