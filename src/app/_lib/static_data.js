...
export const contactStaticData = {
    bg: {
        ...
        companyPlaceholder: "Въведете името на вашата фирма",
        ...
        errors: {
            ...
            agree: "Моля, приемете политиката за поверителност",
        },
        hints: {
            first_name: "Вашето име (задължително)",
            last_name: "Вашата фамилия (задължително)",
