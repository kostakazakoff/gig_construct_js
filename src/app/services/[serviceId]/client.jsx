...
export default function ServiceDetailsComponent() {
    ...
    return (
        <div className="relative my-4 px-4">
            ...
            <section className="w-96 xl:w-128 mt-12 py-4 px-8 bg-slate-300 dark:bg-slate-800/80 dark:backdrop-blur-md sticky bottom-24 sm:bottom-16 left-1/2 text-center rounded-sm shadow-lg z-1 lg:-translate-x-1/2">
