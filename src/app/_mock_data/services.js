export const servicesData = {
    BG: {
        1: {
            ...
            note: "Ценообразуването на услугата се изчислява на квадратен метър."
        },
        2: {
            id: 2,
            name: "ВиК услуги",
            ...
            note: "Ценообразуването на услугата се изчислява на контактна точка и линеен метър."
        },
        3: {
            id: 3,
            name: "Гипсокартон",
        ...
        12: {
            ...
            note: "Ценообразуването на услугата се изчислява на килограм."
        },
    },
    EN: {
        1: {
            id: 1,
            name: "Painting",
            description: "Preparation, priming and painting of various surfaces, parts according to specified requirements and standard norms.",
            src: "/images/services/paint.jpg",
        ...
        2: {
            ...
            description: "Design,   Installation and Dismantling of Water Supply installation of different types of buildings or premises.",
            src: "/images/services/paint.jpg",
            note: "The pricing of the service is calculated per contact point and linear meter."
        },
        3: {
            id: 3,
            name: "Drywall",
            description: "Installation, Dismantling and Replacement of Drywall, Building walls, Cladding, Suspended ceilings.",
            src: "/images/services/paint.jpg",
            note: "The pricing of the service is calculated per contact point and linear meter."
        },
        4: {
            ...
            description: "Design, Installation and Dismantling of High Voltage or Low Voltage electrical installation, of different types of buildings or premises.",
            src: "/images/services/paint.jpg",
            note: "The pricing of the service is calculated per contact point and linear meter."
        },
        5: {
        ...
        9: {
            ...
            description: "Laying of Tiles faience and terracotta tiles - Porcelain stoneware, Natural or artificial stone.",
            src: "/images/services/paint.jpg",
            note: "The pricing of the service is calculated per contact point and linear meter."
        },
        10: {
